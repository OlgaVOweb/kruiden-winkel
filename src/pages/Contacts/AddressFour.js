...
<button className='btn-map' onClick={toggleMap}>{showMap ? "" : ""}<img src={local} alt="local" className='local' width={16} height={18}/>Zaterd Agalkmaar Center (8.00-17.00)</button>
{showMap && (
<iframe
title="Google Map"
width="600"
