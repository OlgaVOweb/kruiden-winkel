...
const AddressFour = () => {
  ...
  return (
    <div>
      <button className='btn-map' onClick={handleButtonClick}><img src={local} alt="local" className='local' width={16} height={18}/>Zaterd Agalkmaar Center (8.00-17.00)</button>
