...
const AddressThird = () => {
  ...
  <button className='btn-map' onClick={toggleMap}>{showMap ? "" : ""}<img src={local} alt="local" className='local' width={16} height={18}/>Vrijdag Hoofdorp Stamplein (8.00-16.30)</button>
  {showMap && (
  <iframe
  title="Google Map"
  width="600"
